        ...
        try:
            ...
            with transaction.atomic():
                ...
                AdminActivityLog.objects.create(
                    table_id=saved_config.config_id,
                    table_name='SiteConfig',
                    ua_action='update' if existing_config else 'create',
                    ua_description=f"{'Updated' if existing_config else 'Created'} site configuration",
...
class PublicSiteInfoView(APIView):
    ...
    def get(self, request):
        try:
            ...
            ALLOWED_DOMAINS = ['yoursite.com', 'localhost:3000', '127.0.0.1:8000']  
