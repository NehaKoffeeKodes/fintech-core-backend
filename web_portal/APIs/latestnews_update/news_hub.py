...
ALLOWED_DOMAIN = getattr(settings, "ALLOWED_DOMAIN", [])
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                AdminActivityLog.objects.create(
                    table_id=instance.record_id,
                    table_name='mailing_subscriber',
                    ua_action='update',
                    ua_description=action_msg,
    ...
    def delete(self, request):
        try:
            ...
            with transaction.atomic():
                ...
                AdminActivityLog.objects.create(
                    table_id=subscriber.record_id,
                    table_name='mailing_subscriber',
                    ua_action='soft_delete',
                    ua_description=f"Removed subscriber: {subscriber.subscriber_email}",
                    created_by=request.user
                )
