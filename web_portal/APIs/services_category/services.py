...
class ServiceCategoryView(APIView):
            ...
            with transaction.atomic():
                ...
                if serializer.is_valid():
                    ...
                    AdminActivityLog.objects.create(
                        table_id=category.pk,
                        table_name='ServiceCategory',
                        ua_action='create',
                        ua_description=f'Added new category "{category.category_title}"',
    ...
    def list_categories(self, request):
        try:
            ...
            add_serial_numbers(page_no, page_size, serializer.data, request.data.get('order_by', 'asc'))
            ...
            with transaction.atomic():
                ...
                if serializer.is_valid():
                    ...
                    AdminActivityLog.objects.create(
                        ...
                        table_name='ServiceCategory',
                        ua_action='update',
                        ua_description=f'Updated category "{category.category_title}"',
                        created_by=request.user,
                        request_data=request.data,
                        response_data=serializer.data
                    )
        ...
        try:
            with transaction.atomic():
                ...
                AdminActivityLog.objects.create(
                    ...
                    table_name='ServiceCategory',
                    ua_action='delete',
                    ua_description=f'Removed category "{category.category_title}"',
                    created_by=request.user,
                    request_data=request.data
                )
