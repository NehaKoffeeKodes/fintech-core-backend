        ...
        try:
            ...
            <body style="font-family: Arial, sans-serif; background:#f4f4f4; padding:20px;">
                <div style="max-width:600px; margin:auto; background:white; padding:30px; border-radius:10px; box-shadow:0 4px 15px rgba(0,0,0,0.1);">
                    ...
                    <p style="font-size:16px; color:#555;">Namaste <strong>Admin</strong>,</p>
                    <p style="font-size:16px; color:#555;">Aapka verification code hai:</p>
                    
                    <div style="text-align:center; margin:30px 0;">
                        <span style="font-size:36px; font-weight:bold; color:#e74c3c; letter-spacing:8px; background:#f8f9fa; padding:15px 30px; border-radius:8px; border:2px dashed #e74c3c;">
                            {otp}
                        </span>
                    </div>
