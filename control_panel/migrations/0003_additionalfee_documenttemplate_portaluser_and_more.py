# Generated by Django 5.2.8 on 2025-12-10 11:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('control_panel', '0002_state_district_citylocation'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registered_city', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='control_panel.citylocation')),
                ('registered_state', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='control_panel.state')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='entities_created_by', to='control_panel.portaluser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('city_ref', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='control_panel.citylocation')),
                ...
                ('state_ref', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='control_panel.state')),
