...
class PortalUserBalance(models.Model):
    ...
    hold_balance = models.DecimalField(max_digits=20, decimal_places=3, default=0.000, null=True, blank=True)
...
class AdServiceProvider(models.Model):
    ...
    uses_identifier = models.BooleanField(default=False)
...
class GlobalBankList(models.Model):
    ...
    dmt_fino_config = models.JSONField(default=dict, blank=True)
    dmt_nsdl_config = models.JSONField(default=dict, blank=True)
    dmt_airtel_config = models.JSONField(default=dict, blank=True)
...
class BulkPeCardInfo(models.Model):
    ...
    expiry_mm_yy = models.CharField(max_length=5)
